...
%       morecomment=[s][\color{gray_ulisses}\ttfamily\tiny]{\{-}{-\}},
        ...
        {[1]
                ...
                unzip3,userError,while,words,writeFile,zip,zip3,zipWith,zipWith3,listArray,doParse
        },
        emphstyle={[1]\textbf},
        emph=
        {[2]
                Bool,Char,Double,Either,Float,IO,Integer,Int,Maybe,Ordering,Rational,Ratio,ReadS,ShowS,String,
                Word8,InPacket,ReT,StT
        },
        emphstyle={[2]\textbf},
        emph=
        {[3]
...
{%\textbf{Haskell Code} \hspace{1cm} \hrulefill
 \lstset{language=HaskellUlisses,    basicstyle=\ttfamily,escapechar=\%}}
{}
...
\newcommand{\parD}{\ensuremath{{{\mathtt{<}}{\ast}{\mathtt{>}}}}}
