module HW1_Martinez where

-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
--
-- 100/100, see explanation at bottom
--
--   Carlos, you should have tested this more extensively,
--   although it is in working order.
--
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
-- define tokens
data Token = ASSIGN | WRITEI | READI | ADDI | SUBI | JUMP | JNZ
           | LABEL | SP | BP | FP | R String | LITERAL String
           | M | LPAREN | RPAREN | LBRACKET | RBRACKET | COMMA
           | PLUS | SCANEOF
           deriving (Show,Eq)
...
tuplelex inp = case parse (many lexer) inp of
