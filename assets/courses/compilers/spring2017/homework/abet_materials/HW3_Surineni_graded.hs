...
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
--
-- Total = 25 + 25 + 13 + 0 = 63/100
--
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
module HW3_Surineni where
...
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
--
-- Problem 1. 25/25. This function is ugly, but alright. 
--
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
-- Consider the examples given in the solution or see me after class for an explanation. 
--
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
noundefined (Program fds) = subseteq ((map f1 fds), (map f2 fds))
  where
    ...
    f2(FunDecl t n params locals cmd) = defvars (FunDecl t n params locals cmd)  
       -- why define these? just use usedvars and defvars (i.e., usedvars==f1 and defvars==f2). -2
--
