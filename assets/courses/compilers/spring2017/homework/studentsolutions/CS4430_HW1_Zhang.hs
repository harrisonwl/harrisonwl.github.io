...
data Token = ASSIGN | WRITEI | READI | ADDI | SUBI | JUMP | JNZ | LABEL
           | SP | BP | FP | R String | LITERAL String
           | M | LBRACKET | RBRACKET | LPAREN | RPAREN | PLUS
           | COMMA | SCANEOF | ID String
           deriving (Show,Eq)
