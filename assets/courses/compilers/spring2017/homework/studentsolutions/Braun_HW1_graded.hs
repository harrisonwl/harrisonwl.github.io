...
data Token = ASSIGN | WRITEI | READI | ADDI | SUBI | JUMP | JNZ | LABEL | LITERAL String 
           | COMMA | RBRACKET | LBRACKET | M | SCANEOF | LPAREN | RPAREN | R String
           | SP | BP | FP | PLUS
		   deriving (Show,Eq)
