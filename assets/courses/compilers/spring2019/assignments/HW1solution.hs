...
prob1a :: Maybe a -> Int
prob1a Nothing  = undefined
prob1a (Just a) = undefined

prob1b :: [a] -> Int
prob1b []     = undefined
prob1b (a:as) = undefined

prob1c :: Nat -> Int
prob1c Zero     = undefined
prob1c (Succ n) = undefined
...
tree :: Tree
tree = Node 0 (Node 1 (Leaf 3) (Leaf 4)) (Node 2 (Leaf 5) (Leaf 6))
...
instance Show Person where
  show King             = "His Majesty the King"
  show (Peer pos loc x) = "The " ++ nth ++ " " ++ pos ++ " of " ++ loc
    where nth :: String
          nth = show x ++ stndrdth x
  show (Knight name)    = "Sir " ++ name
  show (Peasant name)   = name
...
e :: Exp
e = Neg (Add (Const 99) (Neg (Add (Const 101) (Const 72))))
