...
* Currently, Principal Scientist, Galois, Inc. 
* Formerly, Senior Formal Methods Researcher/Directorate Fellow at Idaho National Laboratory
...
* <a href="https://github.com/rewire-hardware/ReWire">The ReWire Functional Hardware Description Language.</a> ReWire is freely available.
...
* _Formalized High Level Synthesis with Applications to Cryptographic Hardware._, Bill Harrison, Ian Blumenfeld, Eric Bond, Chris Hathhorn, Paul Li, May Torrence, and Jared Ziegler. Proceedings of the 2023 NASA Formal Methods Symposium (NFM23). [pdf]({{ site.baseurl }}/assets/papers/nfm23.pdf)  [slides]({{ site.baseurl }}/assets/papers/slides-nfm23.pdf)
